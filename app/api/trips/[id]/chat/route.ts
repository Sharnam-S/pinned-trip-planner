...
- PER-STOP "why" IS REQUIRED: fill every stop's "why" with one sentence explaining why this spot landed on this day at this time — weekday fit, crowds, light, what it pairs with before/after. It's shown on the spot's own card when the user clicks it.
